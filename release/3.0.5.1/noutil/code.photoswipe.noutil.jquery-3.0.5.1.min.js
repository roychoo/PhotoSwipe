...
(function(d,j,a){a.registerNamespace("Code.PhotoSwipe.Cache");d=d.Code.PhotoSwipe;d.Cache.Mode={normal:"normal",aggressive:"aggressive"};d.Cache.Functions={getImageSource:function(a){return a.href},getImageCaption:function(b){if("IMG"===b.nodeName)return a.DOM.getAttribute(b,"alt");var c,f,e;c=0;for(f=b.childNodes.length;c<f;c++)if(e=b.childNodes[c],"IMG"===b.childNodes[c].nodeName)return a.DOM.getAttribute(e,"alt")},getImageMetaData:function(){return{}}}})(window,window.klass,window.Code.Util);
